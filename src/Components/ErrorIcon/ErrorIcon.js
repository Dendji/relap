...
export function ErrorIcon(props) {
    return (
        <svg
            ...
            fill={props.fill || '#cecece'}
        >
            <path
                d="M273.586,214.965c49.111-49.111,49.11-129.021,0-178.132s-129.021-49.111-178.131,0
            ...
            <g>
                <path
                    d="M178.643,151.128c-5.5,0-10-4.5-10-10l-8-71.495c0-5.5,4.5-10,10-10h28.575c5.5,0,10,4.5,10,10l-8,71.495
                c0,5.5-4.5,10-10,10H178.643z"
                />
                <path
                    d="M198.987,184.021c0,4.399-3.601,8-8,8h-12.113c-4.399,0-8-3.601-8-8V171.91c0-4.4,3.601-8,8-8h12.113c4.399,0,8,3.6,8,8
                V184.021z"
                />
            </g>
        </svg>
